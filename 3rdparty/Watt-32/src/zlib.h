...
/*
ZEXTERN int ZEXPORT inflateBackInit (z_stream FAR *strm, int windowBits,
...
ZEXTERN int ZEXPORT inflateBack (z_stream FAR *strm,
...
ZEXTERN int ZEXPORT inflateInit2_ (z_streamp strm, int  windowBits,
                                   const char *version, int stream_size);
ZEXTERN int ZEXPORT inflateBackInit_ (z_stream FAR *strm, int windowBits,
                                      unsigned char FAR *window,
                                      const char *version,
                                      int stream_size);
