...
our %config = (
  ...
  perl_version => "5.26.1",
  perlargv => [ "--with-rand-seed=os,getrandom", "no-threads", "no-hw", "no-shared", "enable-weak-ssl-ciphers", "no-tests", "386", "DJGPP" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
