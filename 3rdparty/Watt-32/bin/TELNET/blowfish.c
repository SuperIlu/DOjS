 ...
 */
static const DWORD parray[] = {
  0x243F6A88, 0x85A308D3, 0x13198A2E, 0x03707344, 0xA4093822, 0x299F31D0,
  0x082EFA98, 0xEC4E6C89, 0x452821E6, 0x38D01377, 0xBE5466CF, 0x34E90C6C,
  0xC0AC29B7, 0xC97C50DD, 0x3F84D5B5, 0xB5470917, 0x9216D5D9, 0x8979FB1B,
};

static const DWORD sbox0[] = {
...
static void blowfish_encrypt (DWORD xL, DWORD xR, DWORD *output,
                              BlowfishContext *ctx)
{
  DWORD *S0 = ctx->S0;
  DWORD *S1 = ctx->S1;
...
static void blowfish_decrypt (DWORD xL, DWORD xR, DWORD *output,
                              BlowfishContext *ctx)
{
  DWORD *S0 = ctx->S0;
  DWORD *S1 = ctx->S1;
...
void blowfish_setkey (BlowfishContext *ctx, short keybytes, const BYTE *key)
{
  ...
  {
    P[i] = parray[i];
    P[i] ^= ((DWORD) (BYTE) (key[(i*4+0) % keybytes])) << 24;
    P[i] ^= ((DWORD) (BYTE) (key[(i*4+1) % keybytes])) << 16;
    P[i] ^= ((DWORD) (BYTE) (key[(i*4+2) % keybytes])) << 8;
    P[i] ^= ((DWORD) (BYTE) (key[(i*4+3) % keybytes]));
  }
