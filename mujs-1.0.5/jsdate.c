...
static int InLeapYear(int t) { return DaysInYear(YearFromTime(t)) == 366; }
...
static void D_now(js_State *J) { js_pushnumber(J, Now()); }
...
static void Dp_setTime(js_State *J) { js_setdate(J, 0, js_tonumber(J, 1)); }
